...
from utils_ import load_candidates_from_json, get_candidate, get_candidates_by_name, get_candidates_by_skill
...
def profile(uid):
    ...
    return render_template('ckentprofile.html', candidate=candidate)
